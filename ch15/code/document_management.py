...
es.index(index=index_name, doc_type="_doc", id="1.1",
                 ...
                 routing=1)
es.index(index=index_name, doc_type="_doc", id=2,
                 body={"name": "Bill Baloney", "parsedtext": "Bill Testere nice guy", "uuid": "22222",
                       "position": 2,
                       "date": datetime(2018, 12, 8), "join_field": {"name": "book"}})
es.index(index=index_name, doc_type="_doc", id="2.1",
                 body={"name": "data2", "value": "value2", "join_field": {"name": "metadata", "parent": "2"}},
                 routing=2)
es.index(index=index_name, doc_type="_doc", id=3, body={"name": "Bill Clinton", "parsedtext": """Bill is not
